 ...
 */
final class Version20200915201811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE actualites (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(100) NOT NULL, image VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, date_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
