...
class CategoriesController extends AbstractController
{
     ...
     */
    public function show(Categories $category, ActualitesRepository $actualitesRepository): Response
    { $actualite = $actualitesRepository->findBy(['category'=> $category->getId()]);  
